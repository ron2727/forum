...
if (!empty($_FILES['image']['name'])) {
    ...
    $sql = "INSERT INTO post(user_id, category_id, title, content, created_at)
    VALUES(:user_id, :category_id, :title, :content, :created_at)";
    ...
    <div class="post-item row my-3 bg-white">
        <div class="col-sm-11">
            ...
            <div class="footer my-1">
                <span class="post-stats">0 <i class="bi bi-eye"></i> - </span>
                <span class="post-stats">0 <i class="bi bi-chat-left"></i></span> 
            </div>
        </div>
